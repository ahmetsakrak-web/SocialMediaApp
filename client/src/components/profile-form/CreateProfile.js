...
const CreateProfile = ({createProfile, history}) => {
    ...
    const [kapali, setAcKapa] = useState(false);
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                    <textarea placeholder="A short bio of yourself" value={bio} onChange={onChange} name="bio"></textarea>
                    <small className="form-text">Tell us a little about yourself</small>
                    </div>

                    <div className="my-2">
                    <button onClick={()=>setAcKapa(!kapali)} type="button" className="btn btn-light">
                    ...
                    <input type="text" placeholder="Facebook URL" value={facebook} onChange={onChange} name="facebook" />
                    </div>
                    ...
                    <input type="text" placeholder="Linkedin URL" value={linkedin} onChange={onChange} name="linkedin" />
                    </div>
